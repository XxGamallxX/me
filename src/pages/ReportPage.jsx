  ...
  return (
    <>
      ...
      <div className="BgReport container-fluid vh-100 d-grid align-items-center grid-report-layout  mt-fornav">
        <div className="row-sm position-relative w-65 mx-auto  mt-5  ">
          ...
          <div className="progress-circles px-0">
            <div
              className={
                step >= 1
                  ? "progress-bar-check-circle"
                  : "progress-bar-uncheck-circle"
              }
            ></div>
            <div
              className={
          ...
          <div className="d-flex form-container justify-content-center p-5 row  w-65 mx-auto align-self-start h-75">
            <form onSubmit={validateStep1} className="justify-self-center">
              ...
              <div className="d-flex justify-content-center pt-4">
                <button type="submit" className="Main-btn-small mx-auto px-4">
                  Next
                </button>
              </div>
            </form>
          ...
          <>
            <form onSubmit={validateStep2}>
              ...
              <div
                className={`drop-zone  ${
                  isDragging ? "dragging" : ""
                } row justify-content-center align-self-start mygap-100 w-75 mx-auto`}
              >
                <div
                  className="image-input-container col-md-5 "
                ...
                >
                  ...
                  <label
                    htmlFor="fileInput"
                    className="d-flex flex-column crusor-pointer p-5"
                  >
                    <img
                      src="/Rafeeq/material-symbols_upload (1).png"
                      alt="Upload icon"
                      className="img-icon-size mx-auto"
                    />
                    <span className="text-center border-20 my-color0A1F44 fw-bold fs-4 my-4">
                      Upload photo here
                    </span>
                    <span className="text-center border-20 fs-5 my-3 mb-4 mt-0">
                      or
                    </span>
                    <div className="text-center  fs-5 ">
                      <span className="p-2 bg-white border-20 d-inline-block">
                        Browse
                      </span>
                    </div>
                  </label>
                ...
                <div className="row justify-content-center w-25">
                  <button type="submit" className="Main-btn-small">
                    next
                  </button>
                </div>
              </div>
        ...
        {step === 3 && (
          <div
            className="row align-self-start justify-content-center "
            style={{ columnGap: "3px" }}
          >
