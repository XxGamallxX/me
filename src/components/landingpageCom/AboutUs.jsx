    ...
    <div className="container w-75 p-3 my-Vh75 d-flex justify-content-center align-items-center" id="AboutUs">
        <div className="text-center">
            ...
            <p className="fs-4">
                ...
                Our platform aims to create a seamless experience for both citizens and authorities,
                fostering a safer and more responsive road environment.
                With a commitment to innovation and user-centric design,
                Rafeeq is shaping the future of road maintenance and public safety.
            </p>
        </div>
    </div>
    )
